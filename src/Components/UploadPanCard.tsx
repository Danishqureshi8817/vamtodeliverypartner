  ...
  return (
    <Container statusBarBackgroundColor='#ffffff' statusBarStyle='dark-content' >
      ...
      <View style={{ marginHorizontal: moderateScale(15) }} >
        ...
        <Text style={styles.headerText}>Pan card details</Text>
      ...
      <PrimaryButton onPress={() => { Navigation.navigate("UploadDrivingLicence") }} buttonText='Next' borderRadius={moderateScale(30)} marginVertical={moderateScaleVertical(15)} marginHorizontal={moderateScale(15)} />
