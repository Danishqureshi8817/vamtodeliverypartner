...
export default function UploadAadhar() {
  ...
  const handleUploadFront = async () => {
    ...
    launchImageLibrary({
      ...
      if (response.didCancel) {
        ...
        addImage('adharCardNumber', response?.assets[0]?.uri);
  ...
  return (
    <Container statusBarBackgroundColor='#ffffff' statusBarStyle='dark-content' >
        ...
        <View style={styles.mainBorder}>
          ...
          {!!selectedFrontImage && <View style={styles.adhar}>
            <Image
              ...
              resizeMode="cover"
              source={{uri:registrationData?.adharCardNumber[0]}}
            />
          </View>}
      ...
      <PrimaryButton onPress={() => { Navigation.navigate("UploadPanCard") }} buttonText='Next' borderRadius={moderateScale(30)} marginVertical={moderateScaleVertical(15)} marginHorizontal={moderateScale(15)} />
